...
export default function Project({
  ...
  return (
    <motion.div
      ...
      className="group xl:w-[calc(50%-1rem)] flex justify-center"
    >
      <section className="max-w-[42rem] border border-black/5 rounded-lg overflow-hidden sm:pr-8 relative sm:h-[20rem] transition text-white bg-white/10 hover:bg-white/20">
